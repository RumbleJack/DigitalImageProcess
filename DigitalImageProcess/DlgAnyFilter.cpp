...
IMPLEMENT_DYNAMIC(CDlgAnyFilter, CDialog)

CDlgAnyFilter::CDlgAnyFilter(CWnd* pParent /*=NULL*/)
	: CDialog(CDlgAnyFilter::IDD, pParent)
{
	m_intType = -1;
	m_iTempH = 0;
	m_iTempW = 0;
...
CDlgAnyFilter::~CDlgAnyFilter()
{
}

void CDlgAnyFilter::DoDataExchange(CDataExchange* pDX)
{
...
BEGIN_MESSAGE_MAP(CDlgAnyFilter, CDialog)
	ON_BN_CLICKED(IDC_RADIO2, &CDlgAnyFilter::OnBnClickedRadio2)
	ON_BN_CLICKED(IDC_RADIO1, &CDlgAnyFilter::OnBnClickedRadio1)
	ON_BN_CLICKED(IDC_RADIO3, &CDlgAnyFilter::OnBnClickedRadio3)
	ON_BN_CLICKED(IDOK, &CDlgAnyFilter::OnBnClickedOk)
END_MESSAGE_MAP()


// CDlgAnyFilter 消息处理程序

void CDlgAnyFilter::OnBnClickedRadio1()
{
	// TODO: 在此添加控件通知处理程序代码
	// 3×3平均模板
	m_intType = 0;
...
void CDlgAnyFilter::OnBnClickedRadio2()
{
	// TODO: 在此添加控件通知处理程序代码
	// 3×3高斯模板
	m_intType = 1;
...
void CDlgAnyFilter::OnBnClickedRadio3()
{
	// TODO: 在此添加控件通知处理程序代码
	// 自定义模板
	m_intType = 2;
...
void CDlgAnyFilter::OnBnClickedOk()
{
	// TODO: 在此添加控件通知处理程序代码
	// 获取用户设置（更新）
	UpdateData(TRUE);
